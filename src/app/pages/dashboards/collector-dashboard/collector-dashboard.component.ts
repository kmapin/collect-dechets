...
@Component({
  ...
  template: `
    <div class="collector-dashboard">
        ...
        <div class="container">
          <div class="header-content">
            <div class="welcome-section">
              ...
              <p class="page-subtitle">{{ currentUser?.firstName }}, votre tournée du {{ today | date:'dd MMMM yyyy' }}</p>
            </div>
            <div class="quick-actions">
              <button class="btn btn-primary" (click)="startRoute()" [disabled]="routeStarted">
        ...
        <div class="dashboard-content">
          ...
          <div class="stats-grid">
            <div class="stat-card card">
              ...
              <div class="stat-info">
                <h3>Progression</h3>
                <p class="stat-value">{{ completedCollections }} / {{ totalCollections }}</p>
            ...
            <div class="stat-card card">
              ...
              <div class="stat-info">
                ...
                <span class="stat-detail">Fin prévue: {{ getEstimatedEndTime() }}</span>
              </div>
            </div>
            ...
            <div class="stat-card card">
              ...
              <div class="stat-info">
                ...
                <p class="stat-value">{{ routeOptimization.totalDistance }} km</p>
                <span class="stat-detail">{{ getRemainingDistance() }} km restants</span>
              </div>
            </div>
            ...
            <div class="stat-card card">
              ...
              <div class="stat-info">
                ...
                <span class="stat-detail">{{ getOpenIncidents() }} en cours</span>
              </div>
            </div>
          </div>
            ...
            <div class="left-column">
              ...
              <section class="collection-schedule card">
                <div class="section-header">
                  ...
                  <div class="schedule-controls">
                    <select [(ngModel)]="selectedView" (change)="updateView()" class="view-select">
                      <option value="today">Aujourd'hui</option>
                      <option value="week">Cette semaine</option>
                    </select>
                    <button class="btn btn-secondary btn-small" (click)="optimizeRoute()">
                ...
                <div class="schedule-timeline">
                  <div *ngFor="let point of collectionPoints; let i = index" 
                       class="timeline-item"
                    ...
                    <div class="timeline-marker">
                      <div class="marker-icon">
                        <i class="material-icons" *ngIf="point.status === 'completed'">check_circle</i>
                        <i class="material-icons" *ngIf="point.status === 'in_progress'">radio_button_checked</i>
                        <i class="material-icons" *ngIf="point.status === 'scheduled'">radio_button_unchecked</i>
                      </div>
                      <div class="marker-time">{{ point.scheduledTime | date:'HH:mm' }}</div>
                    </div>
                    ...
                    <div class="timeline-content">
                      <div class="collection-header">
                        ...
                        <div class="collection-badges">
                          <span class="priority-badge" [class]="'priority-' + point.priority">
                            {{ point.priority === 'urgent' ? 'Urgent' : 'Normal' }}
                          </span>
                          <span class="duration-badge">{{ point.estimatedDuration }}min</span>
                        </div>
                      </div>
                      ...
                      <div class="collection-details">
                        ...
                        <div class="waste-types">
                          <span *ngFor="let type of point.wasteTypes" class="waste-tag">
                            {{ type }}
                          </span>
                        </div>
                      </div>

                      <div class="collection-actions" *ngIf="point.status !== 'completed'">
                        <button class="action-btn navigate" (click)="navigateToPoint(point.id)">
                          <i class="material-icons">directions</i>
                          Navigation
                        </button>
                        <button class="action-btn collect" 
                          ...
                          {{ point.status === 'in_progress' ? 'En cours...' : 'Confirmer' }}
                        </button>
                      </div>
              ...
              <section class="navigation-section card">
                <div class="section-header">
                  ...
                  <button class="btn btn-secondary btn-small" (click)="recalculateRoute()">
                  ...
                  <div class="current-destination" *ngIf="currentDestination">
                    ...
                    <div class="destination-info">
                      ...
                      <div class="destination-distance">
                        ...
                        <span>{{ currentDestination.distance }} km - {{ currentDestination.estimatedDuration }} min</span>
                      </div>
                    </div>
                    <button class="btn btn-primary btn-full" (click)="openMapsNavigation()">
                  ...
                  <div class="route-summary">
                    ...
                    <div class="route-stats">
                      <div class="route-stat">
                        ...
                        <span class="stat-value">{{ routeOptimization.totalDistance }} km</span>
                      </div>
                      <div class="route-stat">
                        <span class="stat-label">Durée estimée:</span>
                        <span class="stat-value">{{ routeOptimization.estimatedDuration }} min</span>
                      </div>
                      <div class="route-stat">
                        <span class="stat-label">Points restants:</span>
                        <span class="stat-value">{{ getRemainingPoints() }}</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="right-column">
              ...
              <section class="collection-confirmation card">
                ...
                <div class="confirmation-form" *ngIf="currentCollection">
                  ...
                  <div class="form-group">
                    ...
                    <textarea [(ngModel)]="collectionNotes" 
                  ...
                  <div class="form-group">
                    ...
                    <div class="photo-upload">
                      <input type="file" #photoInput multiple accept="image/*" 
                             (change)="onPhotosSelected($event)" style="display: none;">
                      <button class="upload-btn" (click)="photoInput.click()">
                        <i class="material-icons">camera_alt</i>
                        Ajouter des photos
                      </button>
                      <div class="photo-preview" *ngIf="selectedPhotos.length > 0">
                        <div *ngFor="let photo of selectedPhotos" class="photo-item">
                          <img [src]="photo.preview" alt="Photo">
                          <button class="remove-photo" (click)="removePhoto(photo)">
                  ...
                  <div class="geolocation-info">
                    <div class="location-status" [class.active]="locationEnabled">
                      <i class="material-icons">{{ locationEnabled ? 'location_on' : 'location_off' }}</i>
                      <span>{{ locationEnabled ? 'Géolocalisation activée' : 'Géolocalisation désactivée' }}</span>
                    </div>
                    <button class="btn btn-secondary btn-small" (click)="enableLocation()" *ngIf="!locationEnabled">
                      Activer la géolocalisation
                    </button>
                  </div>

                  <div class="confirmation-actions">
                    <button class="btn btn-success btn-full" (click)="confirmCurrentCollection()">
              ...
              <section class="incidents-section card">
                <div class="section-header">
                  ...
                  <button class="btn btn-secondary btn-small" (click)="showIncidentModal = true">
                ...
                <div class="incidents-list">
                  <div *ngFor="let incident of todayIncidents" class="incident-item">
                    <div class="incident-icon" [class]="'incident-' + incident.type">
                      <i class="material-icons">{{ getIncidentIcon(incident.type) }}</i>
                    </div>
                    <div class="incident-content">
                      <h4>{{ getIncidentTypeText(incident.type) }}</h4>
                      <p>{{ incident.description }}</p>
                      <div class="incident-meta">
                        <span class="incident-time">{{ incident.timestamp | date:'HH:mm' }}</span>
                        <span class="incident-status" [class]="'status-' + incident.status">
                          {{ incident.status === 'open' ? 'Ouvert' : 'Résolu' }}
                        </span>
                      </div>
                    </div>
                    <button class="resolve-btn" *ngIf="incident.status === 'open'" 
                            (click)="resolveIncident(incident.id)">
                      <i class="material-icons">check</i>
                    </button>
                  </div>

                  <div *ngIf="todayIncidents.length === 0" class="empty-incidents">
                    <i class="material-icons">check_circle</i>
              ...
              <section class="collection-history card">
                <div class="section-header">
                  ...
                  <button class="btn btn-secondary btn-small" routerLink="/collector/history">
                ...
                <div class="history-list">
                  <div *ngFor="let collection of recentHistory" class="history-item">
                    <div class="history-date">
                      <div class="day">{{ collection.collectedDate | date:'dd' }}</div>
                      <div class="month">{{ collection.collectedDate | date:'MMM' }}</div>
                    </div>
                    <div class="history-info">
                      <h4>{{ collection.clientName }}</h4>
                      <p>{{ collection.address }}</p>
                      <div class="history-meta">
                        <span class="collection-time">{{ collection.collectedDate | date:'HH:mm' }}</span>
                        <span class="waste-types">{{ collection.wasteTypes.join(', ') }}</span>
                      </div>
                    </div>
                    <div class="history-status">
                      <span class="status-badge status-completed">Collecté</span>
                    </div>
                  </div>
      ...
      <div class="modal-overlay" *ngIf="showIncidentModal" (click)="showIncidentModal = false">
        <div class="modal-content" (click)="$event.stopPropagation()">
          ...
          <form class="incident-form" (ngSubmit)="submitIncident()">
            ...
            <div class="form-group">
              ...
              <select [(ngModel)]="incidentData.collectionId" name="collectionId" required>
                <option value="">Sélectionnez une collecte</option>
                <option *ngFor="let point of collectionPoints" [value]="point.id">
            ...
            <div class="form-group">
              ...
              <textarea [(ngModel)]="incidentData.description" name="description" 
                        rows="4" placeholder="Décrivez l'incident..." required></textarea>
            </div>
            <div class="form-group">
              <label>Photos (optionnel)</label>
              <div class="photo-upload">
                <input type="file" #incidentPhotoInput multiple accept="image/*" 
                       (change)="onIncidentPhotosSelected($event)" style="display: none;">
                <button type="button" class="upload-btn" (click)="incidentPhotoInput.click()">
                  <i class="material-icons">camera_alt</i>
                  Ajouter des photos
                </button>
                <div class="photo-preview" *ngIf="incidentPhotos.length > 0">
                  <div *ngFor="let photo of incidentPhotos" class="photo-item">
                    ...
                    <button type="button" class="remove-photo" (click)="removeIncidentPhoto(photo)">
                      <i class="material-icons">close</i>
                    </button>
                  </div>
                </div>
            ...
            <div class="form-actions">
              <button type="button" class="btn btn-secondary" (click)="showIncidentModal = false">
                Annuler
              </button>
  ...
  styles: [`
    ...
    .stat-icon.progress { background: var(--primary-color); }
    .stat-icon.time { background: var(--accent-color); }
    .stat-icon.distance { background: var(--secondary-color); }
    ...
    .incident-non_compliant { background: var(--warning-color); color: var(--text-primary); }
    .incident-access_blocked { background: var(--error-color); }
    .incident-equipment_issue { background: var(--accent-color); }
    .incident-other { background: var(--text-secondary); }
...
export class CollectorDashboardComponent implements OnInit {
  ...
  loadTodayCollections(): void {
    ...
    this.completedCollections = this.collectionPoints.filter(p => p.status === CollectionStatus.COMPLETED).length;
    this.currentCollection = this.collectionPoints.find(p => p.status !== CollectionStatus.COMPLETED) || null;
  }
  ...
  startRoute(): void {
    ...
    this.notificationService.showSuccess('Tournée démarrée', 'Bonne collecte !');
  }

  optimizeRoute(): void {
    this.notificationService.showInfo('Optimisation', 'Itinéraire optimisé avec succès');
  }
  ...
  navigateToPoint(pointId: string): void {
    this.notificationService.showInfo('Navigation', 'Ouverture de l\'application de navigation');
  }

  openMapsNavigation(): void {
    this.notificationService.showInfo('Navigation', 'Ouverture dans Google Maps');
  }
  ...
  confirmCurrentCollection(): void {
    if (this.currentCollection) {
      ...
      this.currentCollection = this.collectionPoints.find(p => p.status === CollectionStatus.SCHEDULED) || null;
      
      this.notificationService.showSuccess('Collecte confirmée', 'Collecte enregistrée avec succès');
    }
  }
    ...
    if ('geolocation' in navigator) {
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          this.notificationService.showSuccess('Géolocalisation', 'Position activée');
        },
        (error) => {
          this.notificationService.showError('Erreur', 'Impossible d\'obtenir la position');
        }
      );
    }
  }
  ...
  submitIncident(): void {
    if (this.incidentData.type && this.incidentData.collectionId && this.incidentData.description) {
      ...
      this.notificationService.showSuccess('Incident signalé', 'Votre signalement a été transmis');
    }
  }
  ...
  resolveIncident(incidentId: string): void {
    ...
    if (incident) {
      ...
      this.notificationService.showSuccess('Incident résolu', 'Incident marqué comme résolu');
    }
  }
  ...
  getProgressPercentage(): number {
    return this.totalCollections > 0 ? (this.completedCollections / this.totalCollections) * 100 : 0;
  }

  getRemainingTime(): string {
    const remaining = this.routeOptimization.estimatedDuration - (this.completedCollections * 15);
  ...
  getEstimatedEndTime(): string {
    const now = new Date();
    const endTime = new Date(now.getTime() + (this.routeOptimization.estimatedDuration * 60000));
    return endTime.toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit' });
  }

  getRemainingDistance(): number {
    return Math.round(this.routeOptimization.totalDistance * (1 - this.getProgressPercentage() / 100));
  }
